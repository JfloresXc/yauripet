...
!(function (t, e) {
  if ("object" == typeof exports && "object" == typeof module)
    ...
    var n =
      "object" == typeof exports ? e(require("jquery")) : e(t.jQuery);
    for (var o in n)
      ...
      e.a = {
        create: function (t, e) {
          return function () {
            ...
            return (
              n && n.children && (o = n.children), new s(t, o, n, e)
            );
          };
        },
      };
              ...
              value: function (t, e) {
                ...
                var a = pt.makePredByNodeName(n),
                  s = t
                    ...
                    .map(function (t) {
                      return (
                        pt.singleChildAncestor(t, a) || pt.wrap(t, n)
                      );
                    });
                if (o) {
                  if (r) {
                  ...
                  this.options.airMode
                    ? this.options.overrideContextMenu &&
                      this.$editor.on("contextmenu", function (e) {
                        return (
                          t.context.triggerEvent("contextmenu", e), !1
                        );
                      })
                    : (this.options.width &&
              ...
              value: function () {
                ...
                (this.documentEventHandlers.onDragenter = function (
                  ...
                  var i = t.context.invoke("codeview.isActivated"),
                    r =
                      t.$editor.width() > 0 && t.$editor.height() > 0;
                  i ||
                    e.length ||
                    !r ||
                        ...
                        ],
                        {
                          callback: function (e) {
                            e.find(
                              ...
                              .css({
                                width:
                                  t.options.insertTableMaxSize.col +
                                  "em",
                                height:
                                  t.options.insertTableMaxSize.row +
                                  "em",
                              })
                              .mousedown(
                  ...
                  if ("words" === this.options.hintMode) {
                    if (
                      ...
                      this.hints.forEach(function (t) {
                        if (t.match.test(o))
                          return (
                            (n = r.getWordsMatchRange(t.match)), !1
                          );
                      }),
                      !n)
                    )
