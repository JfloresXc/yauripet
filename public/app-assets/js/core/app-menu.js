...
(function (window, document, $) {
  ...
  var menuWrapperClasses = $('div[data-menu="menu-wrapper"]').attr(
    "class"
  );
  ...
  $.app.menu = {
      ...
      update: function () {
        ...
        if ($(".main-menu").data("scroll-to-active") === true) {
          ...
          if ($body.hasClass("menu-collapsed")) {
            if (
              $(".main-menu-content li.sidebar-group-active").length
            ) {
              activeEl = document.querySelector(
    ...
    change: function (compactMenu) {
      ...
      if (currentBreakpoint) {
        switch (currentBreakpoint.name) {
          case "xl":
            // ACA INICIAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
            if (menuType === "vertical-overlay-menu") {
              this.open();
            } else {
              if (compactMenu === true) this.expand();
              else this.collapse(compactMenu);
            }
            break;
          case "lg":
            if (
    ...
    changeMenu: function (screen) {
      ...
      if (screen === "xl") {
        ...
        $("a.dropdown-item.nav-has-children").on(
          "click",
          function () {
            event.preventDefault();
            event.stopPropagation();
