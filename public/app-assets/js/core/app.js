...
(function (window, document, $) {
  ...
  var assetPath = "../public/app-assets/";
  ...
  $(window).on("load", function () {
    ...
    */
    ...
    $(".content-overlay").on("click", function () {
      ...
      var searchInput = $(".search-input-close").closest(
        ".search-input"
      );
  ...
  if (typeof Hammer !== "undefined") {
    ...
    var swipeOutOverlayElement = document.querySelector(
      ".sidenav-overlay"
    );
  ...
  if ($(".search-list-bookmark").length) {
    var searchListBookmark = new PerfectScrollbar(
        ...
        $.getJSON(
          ...
          function (data) {
            for (var i = 0; i < data.listItems.length; i++) {
              ...
              if (
                data.listItems[i].name.toLowerCase().indexOf(value) ==
                  0 &&
                a < 5
              ) {
                if (a === 0) {
        ...
        if (bookmark === true) {
          ...
          for (var i = 0; i < arrList.length; i++) {
            ...
            var iconName = "",
              className = "";
            if (
              $(arrList[i].firstChild.firstChild).hasClass("feather")
            ) {
              var classString =
  ...
  $(".form-password-toggle .input-group-text").on(
    "click",
    function (e) {
      e.preventDefault();
      var $this = $(this),
