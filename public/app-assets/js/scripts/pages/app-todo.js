...
$(function () {
  ...
  if (idItemManual.length) {
    idItemManual.wrap('<div class="position-relative"></div>');
    idItemManual.select2({
  ...
  todoTaskListWrapper.on(
    ...
    function (event) {
      ...
      if ($this.prop("checked")) {
        ...
        toastr["success"]("Tarea completada", "Felicitaciones!! 🎉", {
          closeButton: true,
          tapToDismiss: false,
          rtl: isRtl,
        });
  ...
  $(document).on(
    ...
    function (e) {
      ...
      idItemManual.val("").trigger("change");
